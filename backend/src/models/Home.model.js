...
const whyChooseUsSchema = new mongoose.Schema(
  {
    ...
    heading: {
      type: String,
      required: true,
      default: "Advanced Care, Personal Touch",
    },
    items: {
      ...
      default: [
        {
          ...
          description: "Latest technology for better results.",
          icon: "equipment",
        },
        {
          title: "Sterilized Clinic",
          description: "Hygiene and safety are our priority.",
          icon: "sterile",
        },
        {
          title: "Expert Care",
        ...
        },
        {
          ...
          description: "Relaxing environment for stress-free visits.",
          icon: "comfort",
        },
        {
          title: "Emergency Care",
          description: "Prompt care for dental emergencies.",
          icon: "heart",
        },
      ],
    },
...
const aboutPreviewSchema = new mongoose.Schema(
  {
    ...
    subHeading: {
      type: String,
      required: true,
      default: "BDS (MIDA) Delhi, IMPLANTOLOGIST",
    },
    image: {
      type: String,
      required: true,
      default:
        "https://res.cloudinary.com/demo/image/upload/w_900,h_1100,c_fill,g_face/docs/doctor.png",
    },
    imageAlt: {
      type: String,
      default: "Dr. Aditya Shivi at City Smile Dental & Implant Clinic",
    },
    ...
    description: {
      type: [String],
      default: [
        "City Smile Dental & Implant Clinic has been known for its unparalleled commitment to patient satisfaction. We provide advanced dental care in a friendly and comfortable environment.",
...
const treatmentProcessSchema = new mongoose.Schema(
  {
    ...
    heading: {
      type: String,
      required: true,
      default: "Your Smile, Our Responsibility",
    },
    steps: {
      ...
      default: [
        ...
        {
          title: "Consultation",
          description: "Detailed check-up & diagnosis.",
          icon: "consultation",
        },
        {
          title: "Treatment Plan",
          description: "Personalized plan for your needs.",
          icon: "plan",
        },
        {
          title: "Quality Treatment",
          description: "Advanced treatment with care.",
          icon: "treatment",
        },
        {
          title: "Healthy Smile",
          description: "Leave with a confident smile!",
          icon: "tooth",
        },
      ],
    },
...
const heroSchema = new mongoose.Schema(
  {
    ...
    heading: {
      type: String,
      required: true,
      default: "Healthy Smile, Healthy Life",
    },
    ...
    description: {
      ...
      required: true,
      default:
        "Providing world-class dental care with advanced technology and a gentle touch.",
    },
    ctaButtons: {
    ...
    heroImageAlt: {
      type: String,
      default: "Dentist treating a smiling patient",
    },
    patientProofText: {
      type: String,
      default: "Trusted by 5000+ Happy Patients",
    },
    patientAvatars: {
