...
const contactSchema = new mongoose.Schema({
  ...
  contactDescription: { type: String, default: 'Reach out to City Smile Dental Clinic for any inquiries.' },
  mapCardTitle: { type: String, default: 'City Smile Dental Clinic' },
}, { timestamps: true });
